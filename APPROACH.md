...
Default (updated 2026-08-25): **faster-whisper `base.en`**, with VAD filtering enabled
(`vad_filter=True`). Originally `tiny.en` per the comparison below; see the update note at
the end of this section for why the default changed.
